$(function() {
  ...
  $(".chosen_destination_shipper_receivers").chosen();
    ...
    $("#input_name_destination0").val(street);

    city = ($('#sr_city_destination0').find("option:selected").text());
    $("#input_name_destination0").val(city);
  ...
  // ---------------
    ...
    $("#input_name_destination1").val(street);

    city = ($('#sr_city_destination1').find("option:selected").text());
    $("#input_name_destination1").val(city);
  ...
  // ---------------
    ...
    $("#input_name_destination2").val(street);

    city = ($('#sr_city_destination2').find("option:selected").text());
    $("#input_name_destination2").val(city);
  ...
  $(document).on("change", "#chosen_destination_shipper_receivers3", function() {
    ...
    $("#input_name_destination3").val(street);

    city = ($('#sr_city_destination3').find("option:selected").text());
    $("#input_name_destination3").val(city);
  ...
  $(document).on("change", "#chosen_destination_shipper_receivers4", function() {
    ...
    $("#input_name_destination4").val(street);

    city = ($('#sr_city_destination4').find("option:selected").text());
    $("#input_name_destination4").val(city);
  ...
  $(this).append('<select id=\"text' +i+'\"></select>');
    ...
    $(this).find('input_name_destination').append(script_street);
  });
  ...
  $(this).append('<select id=\"text' +i+'\"></select>');
    ...
    $(this).find('input_name_destination').append(script_city);
  });
...
$( ".enter_manually_destination" ).each(function( i ) {
  $(this).attr('id', 'enter_manually_destination' + i);
  $(this).append('<input id=\"text' +i+'\"></input>');
    var enter_manually_destination = document.createElement('enter_manually_destination');
    enter_manually_destination.type='text/javascript';
    $(this).find('enter_manually_destination').append(enter_manually_destination);   
  }); 


// #enter_manually_destination0 click
$(function(){
  ids_0 = '#input_name_destination0, #input_name_destination0, #input_name_destination0, #input_state_destination0,       #input_postal_destination0' 
  $('#enter_manually_destination0').click(function() {
      if($(this).is(':checked')) 
...
// #enter_manually_destination1 click
$(function(){
  ids_1 = '#input_name_destination1, #input_name_destination1, #input_name_destination1, #input_state_destination1,       #input_postal_destination1' 
  $('#enter_manually_destination1').click(function() {
      if($(this).is(':checked')) 
...
// #enter_manually_destination2
$(function(){
  ids_2 = '#input_name_destination2, #input_name_destination2, #input_name_destination2, #input_state_destination2,       #input_postal_destination2' 
  $('#enter_manually_destination2').click(function() {
      if($(this).is(':checked')) 
...
// #enter_manually_destination3
$(function(){
  ids_3 = '#input_name_destination3, #input_name_destination3, #input_name_destination3, #input_state_destination3,       #input_postal_destination3' 
  $('#enter_manually_destination3').click(function() {
      if($(this).is(':checked')) 
...
// #enter_manually_destination4
$(function(){
  ids_4 = '#input_name_destination4, #input_name_destination4, #input_name_destination4, #input_state_destination4,       #input_postal_destination4' 
  $('#enter_manually_destination4').click(function() {
      if($(this).is(':checked')) 
