class ShippersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @shipper.save
        format.html { redirect_to @shipper, notice: 'Shipper receiver was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @shipper.update(shipper_params)
        format.html { redirect_to @shipper, notice: 'Shipper receiver was successfully updated.' }
  ...
  def destroy
    @shipper.destroy
    respond_to do |format|
      format.html { redirect_to shippers_url, notice: 'Shipper receiver was successfully destroyed.' }
